...
| 9     | CourseRoleDaysHelper  | 0 18 * * 6      | Weekly    | Builds CourseRoleDays mapping table dynamically from DimCourse and DimRole.                                                                 |
| 10    | CommLicenseDB         | 0 0 19 * * *    | Daily     | ETL from SharePoint license list to Azure SQL; updates DimCommLicense; includes retry                                                       |
...
### 10. CommLicenseDB
- **Runs:** Weekly on Sunday at 21:00
- **Purpose:** Reviews the Comm License Sharepoint List for updates, upserts any net new updates into Azure database table.
